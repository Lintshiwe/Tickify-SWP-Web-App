...
public class AdminDatabaseServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (isMutation(action) && !adminITDAO.isPrivilegedAdmin(adminId)) {
            ...
            if ("executeSql".equals(action)) {
                ...
                Map<String, Object> sqlResult = adminITDAO.executeCrudSql(adminId, sql, rootPassword);
            ...
            if ("updateCell".equals(action)) {
                ...
                boolean ok = adminITDAO.updateSingleCell(
                        adminId,
            ...
            if ("safeDeleteRow".equals(action)) {
                ...
                boolean ok = adminITDAO.safeDeleteRow(adminId, req(request, "tableName"), Integer.parseInt(req(request, "rowId")));
    ...
    private void populateModel(HttpServletRequest request, String msg, String err, Map<String, Object> sqlResult) throws SQLException {
        ...
        request.setAttribute("exportCampusOptions", adminITDAO.getUserExportCampusNamesForScope(adminId));
        ...
        request.setAttribute("ticketCampusOptions", adminITDAO.getUserExportCampusNamesForScope(adminId));
        request.setAttribute("ticketEventOptions", adminITDAO.getEventOptionsForScope(adminId));
    ...
    private void exportUsers(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        List<Map<String, Object>> rows = adminITDAO.getUserDirectoryForExport(
                adminId,
                roleFilter,
                campusFilter,
                search,
    ...
    private void exportTickets(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        List<Map<String, Object>> rows = adminITDAO.getTicketDirectoryForExport(
                adminId,
                campusFilter,
                eventId,
                search,
