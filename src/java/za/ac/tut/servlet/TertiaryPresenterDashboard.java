...
public class TertiaryPresenterDashboard extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Map<String, Object>> materials = presenterDAO.getPresenterMaterials(presenterId);
            List<Map<String, Object>> scheduleItems = presenterDAO.getPresenterScheduleItems(presenterId);
            List<Map<String, Object>> announcements = presenterDAO.getPresenterAnnouncements(presenterId);
            List<Map<String, Object>> attendeeList = presenterDAO.getEventAttendeesForPresenter(presenterId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("addMaterial".equals(action)) {
                ...
                boolean ok = presenterDAO.addPresenterMaterial(
                        presenterId,
                        title,
                        materialUrl,
                        description
            ...
            if ("addScheduleItem".equals(action)) {
                ...
                boolean ok = presenterDAO.addPresenterScheduleItem(
                        presenterId,
                        title,
                        startsAt,
                        endsAt,
            ...
            if ("addAnnouncement".equals(action)) {
                ...
                boolean ok = presenterDAO.addPresenterAnnouncement(
                        presenterId,
                        title,
                        body
                );
