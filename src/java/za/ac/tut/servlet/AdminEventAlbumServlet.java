...
public class AdminEventAlbumServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<java.util.Map<String, Object>> events = adminITDAO.getEventControlRowsForScope(adminId);
            List<java.util.Map<String, Object>> venues = adminITDAO.getVenueOptionsForScope(adminId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("createEvent".equalsIgnoreCase(action)) {
            try {
                int created = adminITDAO.createEvent(
                        adminId,
        ...
        if ("updateEvent".equalsIgnoreCase(action)) {
            try {
                boolean updated = adminITDAO.updateEvent(
                        adminId,
        ...
        if ("clear".equalsIgnoreCase(action)) {
            try {
                boolean cleared = adminITDAO.clearEventAlbumImageForScope(adminId, eventID);
        ...
        try {
            boolean updated = adminITDAO.updateEventAlbumImageForScope(
                    adminId,
                    eventID,
