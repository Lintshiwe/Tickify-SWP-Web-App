        ...
        <script>
            function toggleFields() {
                ...
                if (isAttendee) {
                    ...
                    lblEmail.innerText = 'Attendee Contact Email (Optional)'; lblPass.innerText = 'Attendee Account Password';
                } else {
        ...
        <main>
            <div class="form-container">
                ...
                <% if (err != null) { %>
                    <div class="status error">
                        <%= "Validation".equals(err)
                                ? "Please complete all required fields with a valid username and password."
                ...
                <form action="RegistrationServlet.do" method="POST">
                    ...
                    <div class="input-group"><label id="lblEmail" for="email">Email (Optional)</label><input type="email" id="email" name="email" autocomplete="email"></div>
