                ...
                <div class="field">
                    ...
                    <select name="eventID" required>
                        ...
                        <c:forEach var="ev" items="${events}">
                            <option value="${ev.eventID}">${ev.name} | ${ev.type}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="field">
                    ...
                    <div id="dropzone" class="dropzone" tabindex="0" role="button" aria-label="Drop image or click to select">
                        ...
                        <small>or click to browse (JPG, PNG, SVG)</small>
                    ...
                    <small style="color:var(--muted);">Uploads are automatically center-cropped and resized for ticket dimensions.</small>
                </div>
